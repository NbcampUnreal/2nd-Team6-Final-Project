...
void UNewInventoryItemContainer::BindInventoryDelegates()
{
	...
	if (PlayerCharacter)
	{
		...
		if (ItemComponent)
		{
			ItemComponent->OnInventoryItemListChanged.AddUObject(this, &UNewInventoryItemContainer::OnUpdateInventoryItemList);
		}
	}
}

void UNewInventoryItemContainer::OnUpdateInventoryItemList()
{
